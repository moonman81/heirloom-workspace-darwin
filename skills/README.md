...
- **Subdirs**: heirloom-non-authoritative-downstream-port, heirloom-per-file-license-patchwork, heirloom-port-alm-lifecycle, patches-materialised-in-repo, pre-commit-as-sole-qa-gate, qa-reports-in-git-for-diffable-audit
